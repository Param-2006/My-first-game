...
if(keyDown("space")||gameState==="question"){
    gameState="question";
    fill("white");
    ...
    if(mousePressedOver(square1)||gameState==="answer"){
        gameState="answer";
    ...
    else if(mousePressedOver(square2)||gameState==="answer"){
        gameState="answer";
        square2.shapeColor="red";
        text("Sorry! this is the wrong answer",200,530);
        text("It was the news paper boy because tuesday's and wednesday's newspapers were missing",200,550);
    }
    else if(mousePressedOver(square3)||gameState==="answer"){
        gameState="answer";
